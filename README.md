...
| Dataset | Coverage | Measurements | File |
| :--- | :---: | :--- | :--- |
| **Composite Ca ii K PNI** | **1904-2022** | Yearly northern and southern PNI values with uncertainties, combining KoSO and PSPT-R Ca ii K measurements. | [`KoSO_CaIIK_PNI_composite_yearly.txt`](data/KoSO_CaIIK_PNI_composite_yearly.txt) |
| **Reconstructed Polar Field** | **1904-2022** | Yearly northern and southern polar magnetic fields with uncertainties, reconstructed from PNI and calibrated separately against WSO and AFT polar fields. | [`KoSO_CaIIK_polarfield_yearly.txt`](data/KoSO_CaIIK_polarfield_yearly.txt) |
...
![Reconstructed polar magnetic fields calibrated with WSO and AFT](plots/apjadb3a8f7_lr.jpg)

![Composite Ca ii K polar network index](plots/apjadb3a8f8_lr.jpg)
